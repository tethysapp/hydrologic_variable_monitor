...
# from ..app import HydrologicTrendsMonitor
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.hydro_var_monitor"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.hydro_var_monitor.tests.tests"

        To run tests in the HydrologicTrendsMonitorTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydro_var_monitor.tests.tests.HydrologicTrendsMonitorTestCase"

        To run only the test_if_tethys_platform_is_great function in the HydrologicTrendsMonitorTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydro_var_monitor.tests.tests.HydrologicTrendsMonitorTestCase.test_if_tethys_platform_is_great"
...
class HydrologicTrendsMonitorTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(HydrologicTrendsMonitor)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(HydrologicTrendsMonitor)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/hydrologic-trends-monitor/')  # The final '/' is essential for all pages/controllers
